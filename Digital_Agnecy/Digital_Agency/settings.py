...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'Digital_App.context_processors.cart_item_count',
                'django.template.context_processors.request',
...
TINYMCE_DEFAULT_CONFIG = {
    ...
    'toolbar': '''
        ...
        alignleft alignright alignjustify | bullist numlist outdent indent | 
        table link image media | forecolor backcolor | 
        code | fullscreen
        ''',
    'menubar': True,
    'statusbar': True,
